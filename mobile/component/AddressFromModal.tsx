        ...
        <SafeScreen>
          ...
          >
            <View className='p-6 '>
              ...
              {/* Pin Code Input */}
              <View className="mb-5">
                <Text className="text-text-primary font-semibold mb-2">Pin Code</Text>
                <TextInput
                  className="bg-surface text-text-primary px-4 py-4 rounded-2xl text-base"
                  placeholder="e.g., 10001"
                  placeholderTextColor="#666"
                  value={addressForm.pinCode}
                  onChangeText={(text) => onFormChange({ ...addressForm, pinCode: text })}
...
export default AddressFromModal