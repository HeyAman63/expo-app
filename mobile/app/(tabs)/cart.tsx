...
export default function CartScreen(){
  ...
  const handleProceedWithPayment = async(selectedAddress:Address)=>{
    ...
    try {
      ...
      // create a payment intent with carditem and shipping address
      ...
      if(presentError){
        ...
        Alert.alert("Success","Your Payment was successfull! your Order is being processed.",[
          {text:"Ok",onPress:()=>{}}
        ])
        clearCart();
      }
  ...
  return (
    <SafeScreen>
      <Text className='px-6 text-text-primary text-3xl mb-3 font-bold tracking-tight'>cart</Text>
      <ScrollView 
      className='flex-1'
      ...
      onClose={()=>setAddressModalIsVisible(!addressModalIsVisible)}
